...
public class TextUtil {
	 ...
	 * @return
	 */
	public static InputStream getingToInputStream(String xml) {
		ByteArrayInputStream geteam = new ByteArrayInputStream(xml.getBytes());
		return geteam;
	}
	 ...
	 * @return
	 */
	public static int getTextLengthes(String get) {
		int number = getTextLength(get);
		int length = number / 2;
		if (number % 2 != 0) {
			length += 1;
		}
	 ...
	 * @return
	 */
	public static int getTextLength(String get) {
		int length = 0;
		try {
			get = new String(get.getBytes("GBK"), "ISO8859_1");
			length = get.length();
	...
	public static int getText(String get){
		int length = 0;
		length = get.length();
		return length;
	}
