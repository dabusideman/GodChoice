package xuezhangyouhuo.com.tools;
...
public class BitmapLoader {
    ...
    public static String saveBitmapToLocal(Bitmap bitmap, Context context, String userName) {
        ...
        File imgFile;
        try {
            File desDir = new File(XuezhangYouHuoApplication.PICTURE_DIR);
            if (!desDir.exists()) {
                desDir.mkdirs();
            }
            imgFile = new File(XuezhangYouHuoApplication.PICTURE_DIR, userName + ".png");
