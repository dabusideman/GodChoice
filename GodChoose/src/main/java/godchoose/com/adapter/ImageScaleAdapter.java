...
import godchoose.com.photoview.PhotoViewAttacher;
import godchoose.com.widget.BottomPreservationImage;
...
public class ImageScaleAdapter extends PagerAdapter {
	...
	public Object instantiateItem(ViewGroup container, final int position) {
		...
		ImageView imageView = new ImageView(GodchooseApplication.getContext());
